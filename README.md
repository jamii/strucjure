...
The output of a view is the value corresponding to the first matching pattern.
...
The special form 'prefix' may leave part of the input unconsumed and otherwise behaves like a vector. This is explained in more detail in the parsing section later.
...
(defview balanced
  Leaf 0
  (and (Black. _ (balanced ?l) (balanced ?r)) #(= l r)) (+ 1 l)
  (and (Red. _ (and (not Red) (balanced ?l)) (and (not Red) (balanced ?r))) #(= l r)) l)

(defn balanced? [tree]
  (balanced tree (fn [_ _] true) (fn [] false)))
