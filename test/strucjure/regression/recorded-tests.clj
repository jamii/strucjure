...
(def num ((quote num) (eval (graph->views eg-num-out true true))))
(num (quote zero))
(num (quote foo))
...
(pattern->view (->Is (fn* [p1__26291#] (symbol? p1__26291#))) true true)
...
(def num ((quote num) (eval (graph->views (graph-with-trace num-out) true true))))
(num (quote zero))
