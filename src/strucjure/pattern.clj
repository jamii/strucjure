(ns strucjure.pattern
  ...
  (:require strucjure.view
            strucjure.walk
            clojure.set))

;; A pattern takes an input and a set of bindings, consumes some or all of the input and returns new bindings
;; A view can be constructed from a list of [pattern value] pairs, where the value forms have access to the patterns bindings
...
(defn hast->last [form]
  (if (instance? strucjure.pattern.HAST form)
